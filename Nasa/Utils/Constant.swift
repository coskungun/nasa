...
struct Constant
{
    ...
    static var arrFilterCuriosity = ["FHAZ","RHAZ","MAST","CHEMCAM","MAHLI","MARDI","NAVCAM"]
    static var arrFilterOpportunity = ["FHAZ","RHAZ","NAVCAM","PANCAM","MINITES"]
    static var arrFilterSpirit = ["FHAZ","RHAZ","NAVCAM","PANCAM","MINITES"]
